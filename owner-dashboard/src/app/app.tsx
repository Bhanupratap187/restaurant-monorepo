...
const ProtectedRoute: React.FC<{ 
  ...
  if (requiredFeature && user && !canAccessFeature(user.role, requiredFeature)) {
    return (
      <DashboardLayout>
        <div className="text-center py-12">
          ...
          <p className="text-sm text-gray-500">
            Required feature: <code className="bg-gray-100 px-2 py-1 rounded">{requiredFeature}</code>
          </p>
        </div>
      </DashboardLayout>
    );
        ...
        element={
          <ProtectedRoute requiredFeature="staff">
            <ComingSoonPage 
              ...
              description="Add a new team member to your restaurant."
            />
          </ProtectedRoute>
        } 
      />
